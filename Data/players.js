// DURMIND roster data.
// Add/edit players here; Main.js only renders this data.
window.DURMIND_DATA = window.DURMIND_DATA || {};

window.DURMIND_DATA.players = [
  {
    name: "Waysiemens",
    role: "Лідер команди",
    avatar: ".\\photo\\Players\\waysiemens.jpg",
    description: "Надихаючий лідер і капітан цього корабля.",
    socials: {
      steam: "https://steamcommunity.com/id/waysiemens/",
      discord: window.DURMIND_DATA.discordInvite,
  ...
  },
  {
    name: "SMAKOVV",
    role: "Майстер дріфту",
    avatar: ".\\photo\\Players\\Fortuna.jpg",
  ...
  },
  {
    name: "Bareski",
    role: "Геній гри",
    avatar: ".\\photo\\Players\\Bareski.jpg",
  ...
  },
  {
    name: "Edgar",
    role: "Пірат",
    avatar: ".\\photo\\Players\\Edgar.jpg",
  ...
  },
  {
    name: "Mental",
    role: "Аналітик",
    avatar: ".\\photo\\Players\\Mental.jpg",
    description: "Аналітик і філософ, завжди присутній на футболі.",
    socials: {
  ...
  {
    name: "TUR-9000",
    role: "Потужний стрілець",
    avatar: ".\\photo\\Players\\TUR-9000.jpg",
    description: "Точно відчуває момент і завжди готовий вистрілити, коли це потрібно.",
    socials: {
  ...
  },
  {
    name: "Ger4eek",
    role: "Мисливець",
    avatar: ".\\photo\\Players\\Ger4ek.jpg",
